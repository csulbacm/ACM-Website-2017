...
const config = {
	...
	ABOUT : {
		TEXT : [{
			...
			"We also work to strengthen the bond between the students, the faculty, and the Computer Engineering and Computer Science (CECS) department. A stronger, tighter relationship students and their instructors engenders a friendly, energetic, close-knit and secure learning atmosphere.",
